...
000000000000382a <func4>:
    ...
    3834:	89 fb                	mov    %edi,%ebx
    3836:	48 89 f5             	mov    %rsi,%rbp
    3839:	83 ff 09             	cmp    $0x9,%edi
    383c:	77 2d                	ja     386b <func4+0x41>
    ...
    3853:	29 c8                	sub    %ecx,%eax
    3855:	8d 04 80             	lea    (%rax,%rax,4),%eax
    3858:	01 c0                	add    %eax,%eax
    385a:	29 c2                	sub    %eax,%edx
    385c:	39 fa                	cmp    %edi,%edx
    385e:	0f 94 c0             	sete   %al
    3861:	0f b6 c0             	movzbl %al,%eax
    3864:	48 83 c4 08          	add    $0x8,%rsp
    3868:	5b                   	pop    %rbx
    3869:	5d                   	pop    %rbp
    386a:	c3                   	retq   
    386b:	48 63 ff             	movslq %edi,%rdi
    386e:	48 69 ff 67 66 66 66 	imul   $0x66666667,%rdi,%rdi
    3875:	48 c1 ff 22          	sar    $0x22,%rdi
    3879:	89 d8                	mov    %ebx,%eax
    387b:	c1 f8 1f             	sar    $0x1f,%eax
    387e:	29 c7                	sub    %eax,%edi
    3880:	e8 a5 ff ff ff       	callq  382a <func4>
    3885:	85 c0                	test   %eax,%eax
    3887:	74 db                	je     3864 <func4+0x3a>
...
00000000000038e4 <phase_4>:
    ...
    3959:	8b 7c 24 0c          	mov    0xc(%rsp),%edi
    395d:	e8 c8 fe ff ff       	callq  382a <func4>
    3962:	85 db                	test   %ebx,%ebx
...
00000000000039d8 <phase_6>:
    ...
    3a25:	48 83 c3 01          	add    $0x1,%rbx
    3a29:	83 fb 05             	cmp    $0x5,%ebx
    3a2c:	0f 8f 9d 00 00 00    	jg     3acf <phase_6+0xf7>
    3a32:	41 8b 44 9d 00       	mov    0x0(%r13,%rbx,4),%eax
    3a37:	39 45 00             	cmp    %eax,0x0(%rbp)
    3a3a:	75 e9                	jne    3a25 <phase_6+0x4d>
    3a3c:	eb e2                	jmp    3a20 <phase_6+0x48>
    3a3e:	49 8d 4c 24 18       	lea    0x18(%r12),%rcx
    3a43:	ba 07 00 00 00       	mov    $0x7,%edx
    3a48:	89 d0                	mov    %edx,%eax
    3a4a:	41 2b 04 24          	sub    (%r12),%eax
    3a4e:	41 89 04 24          	mov    %eax,(%r12)
    3a52:	49 83 c4 04          	add    $0x4,%r12
    3a56:	4c 39 e1             	cmp    %r12,%rcx
    3a59:	75 ed                	jne    3a48 <phase_6+0x70>
    3a5b:	be 00 00 00 00       	mov    $0x0,%esi
    3a60:	8b 0c b4             	mov    (%rsp,%rsi,4),%ecx
    3a63:	b8 01 00 00 00       	mov    $0x1,%eax
    ...
    3a8e:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx
    3a93:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    3a98:	48 89 43 08          	mov    %rax,0x8(%rbx)
