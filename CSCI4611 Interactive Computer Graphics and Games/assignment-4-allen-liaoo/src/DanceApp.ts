...
{    
    ...
    loadMotionClips(): void
    {
        ...
        motion1.loadFromAMC('./assets/data/05_06.amc', this.balletBoneData);    // changed from 02 -> 06    // cartwheel forward (if at start, steps right to the camera)
        ...
        const files = [
            '05_16.amc',    // going back
            '05_09.amc',    // long pause at start, steps forward
            '05_02.amc',    // default, steps forward
            '05_12.amc'     // very long pause at start, turns around
        ]
        for (let i = 0; i < 4; i++) {
            const motion = new MotionClip();
            motion.loadFromAMC(`./assets/data/${files[i]}`, this.balletBoneData);
            this.balletDanceMotions.push(motion);
        }

        // const motion5 = new MotionClip();
        // motion5.loadFromAMC('./assets/data/05_16.amc', this.balletBoneData);
        ...
        // this.balletDanceMotions.push(motion3); // need to trim front

        // const motion4 = new MotionClip();
        // motion4.loadFromAMC('./assets/data/05_10.amc', this.balletBoneData);
    ...
    onSkeletonsAndMotionClipsLoaded(): void
    {
        ...
        this.balletDanceMotions.forEach(e=>console.log(e))

        // 05_06
        this.balletDanceMotions[0].trimBack(120);   // stops for a little bit

        // 05_09
        this.balletDanceMotions[1].trimFront(60)    // the start glitches

        // 05_02
        this.balletDanceMotions[2].trimFront(550);  // starts slow
        ...
        // 05_12
        this.balletDanceMotions[4].trimFront(1000);
