...
export class JointSpaceAxesCharacter extends AnimatedCharacter
{
    ...
    public override addGeometryToAnimatedBone(bone: AnimatedBone): void
    {
        ...
        const axMat = gfx.Matrix4.multiply(bone.getLocalToParentMatrix(), bone.jointSpaceToBoneSpace)

        // Use quaternion with bone direction?
        // const Q1: gfx.Quaternion = gfx.Quaternion.makeRotationX(bone.direction.x)
        // Q1.multiply(gfx.Quaternion.makeRotationY(bone.direction.y))
        // Q1.multiply(gfx.Quaternion.makeRotationZ(bone.direction.z))

        // Use makealign with bone direction?
        // const rot = gfx.Matrix4.makeAlign(new gfx.Vector3(1,0,0), bone.direction)
        // axes.setLocalToParentMatrix(gfx.Matrix4.multiply(rot, axMat), false)

        // const axMat = bone.getLocalToParentMatrix()
        // axes.setLocalToParentMatrix(gfx.Matrix4.multiply(bone.boneSpaceToJointSpace, axMat), false)
